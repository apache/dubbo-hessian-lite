...
public class ChronoZonedDateTimeImplHandle implements HessianHandle, Serializable {
    ...
    public ChronoZonedDateTimeImplHandle(ChronoZonedDateTime o) {
        this.localDateTime = o.toLocalDateTime();
        this.zoneOffset = o.getOffset();
        this.zone = o.getZone();
    }

    private Object readResolve() {
        return localDateTime.atZone(zoneOffset).withZoneSameLocal(zone);
    }
}
